...
def organize_images():  # No source_folder argument
    """
    ...
    training_inputs = "C:/Users/lochana.marasingha/Downloads/Crop-Residue/Training/input"
        ...
        for root, _, files in os.walk(source_folder):
            for file in files:
                if file.lower().endswith(".jpg"):
                    ...
                    shutil.copy2(source_path, training_inputs)
                    ...
                    new_filename = f"{new_filename_base}.tif"  # Add .tif extension
                    print(new_filename)
